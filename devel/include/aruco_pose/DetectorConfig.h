...
//#line 292 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(DetectorConfig::AbstractParamDescriptionConstPtr(new DetectorConfig::ParamDescription<int>("cornerRefinementMethod", "int", 0, "Corner refinement method", "{'enum': [{'name': 'CORNER_REFINE_NONE', 'type': 'int', 'value': 0, 'srcline': 38, 'srcfile': '/home/max/final-project/src/clover/aruco_pose/cfg/Detector.cfg', 'description': 'No refinement', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'CORNER_REFINE_SUBPIX', 'type': 'int', 'value': 1, 'srcline': 39, 'srcfile': '/home/max/final-project/src/clover/aruco_pose/cfg/Detector.cfg', 'description': 'Do subpixel refinement', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'CORNER_REFINE_CONTOUR', 'type': 'int', 'value': 2, 'srcline': 40, 'srcfile': '/home/max/final-project/src/clover/aruco_pose/cfg/Detector.cfg', 'description': 'Use contour-Points', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'CORNER_REFINE_APRILTAG', 'type': 'int', 'value': 3, 'srcline': 41, 'srcfile': '/home/max/final-project/src/clover/aruco_pose/cfg/Detector.cfg', 'description': 'Use the AprilTag2 approach', 'ctype': 'int', 'cconsttype': 'const int'}], 'enum_description': 'An enum to set corner refinement method'}", &DetectorConfig::cornerRefinementMethod)));
//#line 292 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 38 "/home/max/final-project/src/clover/aruco_pose/cfg/Detector.cfg"
      const int Detector_CORNER_REFINE_NONE = 0;
//#line 39 "/home/max/final-project/src/clover/aruco_pose/cfg/Detector.cfg"
      const int Detector_CORNER_REFINE_SUBPIX = 1;
//#line 40 "/home/max/final-project/src/clover/aruco_pose/cfg/Detector.cfg"
      const int Detector_CORNER_REFINE_CONTOUR = 2;
//#line 41 "/home/max/final-project/src/clover/aruco_pose/cfg/Detector.cfg"
