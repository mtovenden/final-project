...
echo_and_run cd "/home/max/final-project/src/clover/clover"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/max/final-project/src/clover/clover/setup.py" \
     \
    build --build-base "/home/max/final-project/build/clover/clover" \
    install \
    --root="${DESTDIR-/}" \
